...
export const occasions: Record<OccasionSlug, Occasion> = {
  wedding: {
    ...
    description: "Личная свадебная история — светлая, тактильная и живая.",
    ...
    targetDate: "2026-09-12T15:30:00+03:00", durationMinutes: 480,
  ...
  kids: {
    ...
    description:"Игровой мир для детей. Понятные детали для родителей.",accent:"#ff6847",surface:"#ddf5e8",text:"#213b39",date:"20 сентября 2026",
    names:"МИШЕ 7!",greeting:"Команда исследователей, готовьтесь! Мы отправляемся на Планету Семь — там будут сокровища, эксперименты и очень много торта.",venue:"Творческая станция «Лес»",address:"Москва, ул. Большая Дмитровка, 32",mapUrl:"https://yandex.ru/maps/?text=Большая%20Дмитровка%2032",dress:"Любимый цвет и удобная обувь",gift:"Если хотите порадовать Мишу — выберите книгу или набор для опытов.",contact:"Мама Лена · +7 900 000-00-00",
    targetDate:"2026-09-20T13:00:00+03:00",durationMinutes:180,schedule:[{time:"13:00",title:"Сбор команды",note:"Знакомимся и получаем значки"},{time:"13:30",title:"Большой квест",note:"Ищем семь артефактов"},{time:"15:00",title:"Торт",note:"Загадываем желание"},{time:"16:00",title:"Домой",note:"С подарком исследователя"}],
    rsvpQuestions:["Имя и возраст ребёнка","Сопровождающий","Аллергии","Любимый герой"],features:["Отдельный мир","Аллергии и питание","Сопровождающие","Маршрут для родителей"]
  },
  business: {
  ...
  anniversary: {
    ...
    description:"Тёплая история о человеке и людях рядом.",accent:"#c48a54",surface:"#39191d",text:"#fff0db",date:"3 октября 2026",
    names:"ОЛЕГ · 50",greeting:"Полвека — прекрасный повод собрать за одним столом людей, благодаря которым каждая глава получилась настоящей.",venue:"Дом литераторов",address:"Москва, Большая Никитская, 53",mapUrl:"https://yandex.ru/maps/?text=Большая%20Никитская%2053",dress:"Вечерний · бордовый акцент",gift:"Принесите одну фотографию или историю — соберём семейную киноленту.",contact:"Дочь Алина · +7 900 000-00-00",targetDate:"2026-10-03T18:00:00+03:00",durationMinutes:240,
