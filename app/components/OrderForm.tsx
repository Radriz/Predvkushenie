...
const empty:Draft={eventType:"wedding",name:"",contact:"",eventDate:"",city:"",guestCount:"",budget:"9 900–17 900 ₽",selectedStyle:"Кинематографичный",modules:["Ответы гостей","Карта и программа"],musicMood:"Деликатный фон",message:"",consent:false,website:""};
