...
export const metadata:Metadata={title:"Обсудить событие — ПРЕДВКУСИЕ",description:"Расскажите о событии — мы подготовим первую идею кинематографичного приглашения."};
